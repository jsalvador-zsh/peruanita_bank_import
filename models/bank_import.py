...
class BankImport(models.Model):
    ...
    def _create_excel_import_line(self, row, col_mapping, parser_type):
        ...
        try:
            ...
            # Manejar cargo y abono para Banco de la Nación
            if 'cargo' in col_mapping:
                ...
                if cargo_value:
                    try:
                        ...
                        amount = -abs(cargo)  # Cargo es negativo
                    except:
                        pass
            ...
            if 'abono' in col_mapping:
                ...
                if abono_value:
                    try:
                        ...
                        amount = abs(abono)  # Abono es positivo
                    except:
                        pass
    ...
    def _check_operation_match(self, payment, operation_number):
        ...
        # (esto se puede configurar como opción más adelante)
        return False
